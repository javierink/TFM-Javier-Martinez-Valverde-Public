...
public class SurveyStress8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_survey_stress8);
    ...
    public void nextQuestion(View v) {
        ...
        if(checkbox1.isChecked()){
            ...
            intent = new Intent(SurveyStress8.this, SurveyStress9.class);

            //Put in it the answers to the current question
            bundle.putString("8", "1");
