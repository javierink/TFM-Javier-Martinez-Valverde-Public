...
public class Survey_physical_state_4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_survey_physical_state_4);
    ...
    public void nextQuestion(View v) {
        ...
        if(checkbox1.isChecked()){
            ...
            intent = new Intent(Survey_physical_state_4.this, Survey_physical_state_5.class);
            ...
            bundle.putString("4", Integer.toString(total));
