...
public class SurveyStress12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_survey_stress12);
    ...
    public void nextQuestion(View v) {
        ...
        if(checkbox1.isChecked()){
            ...
            intent = new Intent(SurveyStress12.this, SurveyStress13.class);

            //Put in it the answers to the current question
            bundle.putString("12", "1");
