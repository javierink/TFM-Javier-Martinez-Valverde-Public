...
import com.example.healthcarehighbloodpressure.surveys.survey_stress.SurveyStress2;
/**
 * First activity class for the depression survey
 */
public class SurveyDepression1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_survey_depression1);
    ...
    public void nextQuestion(View v) {
        ...
        if(checkbox1.isChecked()){
            ...
            intent = new Intent(SurveyDepression1.this, SurveyDepression2.class);
