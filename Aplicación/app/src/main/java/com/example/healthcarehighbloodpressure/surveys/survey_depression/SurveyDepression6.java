...
public class SurveyDepression6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_survey_depression6);
    ...
    public void nextQuestion(View v) {
        ...
        if(checkbox1.isChecked()){
            ...
            intent = new Intent(SurveyDepression6.this, SurveyDepression7.class);
