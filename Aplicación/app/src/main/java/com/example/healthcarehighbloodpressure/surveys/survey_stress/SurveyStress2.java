...
import com.example.healthcarehighbloodpressure.surveys.survey_social.SurveySocial3;

public class SurveyStress2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_survey_stress2);
    ...
    public void nextQuestion(View v) {
        ...
        if(checkbox1.isChecked()){
            ...
            intent = new Intent(SurveyStress2.this, SurveyStress3.class);
