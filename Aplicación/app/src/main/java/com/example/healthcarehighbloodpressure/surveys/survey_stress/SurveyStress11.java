...
public class SurveyStress11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_survey_stress11);
    ...
    public void nextQuestion(View v) {
        ...
        if(checkbox1.isChecked()){
            ...
            intent = new Intent(SurveyStress11.this, SurveyStress12.class);

            //Put in it the answers to the current question
            bundle.putString("11", "1");
