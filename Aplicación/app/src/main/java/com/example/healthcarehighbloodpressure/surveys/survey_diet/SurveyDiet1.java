...
/**
 * First activity class for the diet survey
 */
public class SurveyDiet1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_survey_diet1);
    ...
    public void nextQuestion(View v) {
        ...
        if(checkbox1.isChecked()){
            ...
            intent = new Intent(SurveyDiet1.this, SurveyDiet2.class);
