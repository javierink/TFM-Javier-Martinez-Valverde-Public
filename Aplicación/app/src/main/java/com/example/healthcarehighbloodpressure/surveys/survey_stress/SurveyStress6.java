...
public class SurveyStress6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_survey_stress6);
    ...
    public void nextQuestion(View v) {
        ...
        if(checkbox1.isChecked()){
            ...
            intent = new Intent(SurveyStress6.this, SurveyStress7.class);
