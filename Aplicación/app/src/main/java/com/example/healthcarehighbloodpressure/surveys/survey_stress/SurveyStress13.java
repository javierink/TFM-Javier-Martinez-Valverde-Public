...
public class SurveyStress13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_survey_stress13);
    ...
    public void nextQuestion(View v) {
        ...
        if(checkbox1.isChecked()){
            ...
            intent = new Intent(SurveyStress13.this, SurveyStress14.class);

            //Put in it the answers to the current question
            bundle.putString("13", "1");
