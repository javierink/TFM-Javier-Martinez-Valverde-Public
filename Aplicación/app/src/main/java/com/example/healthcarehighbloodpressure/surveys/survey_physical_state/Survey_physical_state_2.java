...
public class Survey_physical_state_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_survey_physical_state_2);
    ...
    public void nextQuestion(View v) {
        ...
        if(checkbox1.isChecked()){
            ...
            intent = new Intent(Survey_physical_state_2.this, Survey_physical_state_3.class);
            ...
            // The total time is calculated in minutes
            int total;
            int h = 0;
            int m = 0;
            ...
            bundle.putString("2", Integer.toString(total));
