...
public class SurveyStress9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_survey_stress9);
    ...
    public void nextQuestion(View v) {
        ...
        if(checkbox1.isChecked()){
            ...
            intent = new Intent(SurveyStress9.this, SurveyStress10.class);

            //Put in it the answers to the current question
            bundle.putString("9", "1");
