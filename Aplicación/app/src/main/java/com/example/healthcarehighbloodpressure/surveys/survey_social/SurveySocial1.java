...
import com.example.healthcarehighbloodpressure.surveys.survey_diet.SurveyDiet2;
/**
 * First activity class for the social survey
 */
public class SurveySocial1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_survey_social1);
    ...
    public void nextQuestion(View v) {
        ...
        if(checkbox1.isChecked()){
            ...
            intent = new Intent(SurveySocial1.this, SurveySocial2.class);
