package com.example.healthcarehighbloodpressure.surveys.survey_stress;
...
import com.example.healthcarehighbloodpressure.surveys.survey_social.SurveySocial2;

/**
 * First activity class for the stress survey
 */
public class SurveyStress1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_survey_stress1);
        ...
        //Add functionality for uncheck others checkbox when check a new
    ...
    public void nextQuestion(View v) {
        ...
        if(checkbox1.isChecked()){
            ...
            intent = new Intent(SurveyStress1.this, SurveyStress2.class);
