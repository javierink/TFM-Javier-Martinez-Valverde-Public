...
public class SurveyDepression7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_survey_depression7);
    ...
    public void nextQuestion(View v) {
        ...
        if(checkbox1.isChecked()){
            ...
            intent = new Intent(SurveyDepression7.this, SurveyDepression8.class);
