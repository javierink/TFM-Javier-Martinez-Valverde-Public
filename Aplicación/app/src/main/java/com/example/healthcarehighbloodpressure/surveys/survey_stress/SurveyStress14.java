...
import com.example.healthcarehighbloodpressure.surveys.survey_social.SurveySocial7;

public class SurveyStress14 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_survey_stress14);
    ...
    public void finish(View v) {
        ...
        if(checkbox1.isChecked()){
            ...
            bundle.putString("14", "3");

            finish = true;

        }else if(checkbox4.isChecked()){

            bundle.putString("14", "4");

            finish = true;

        }else if(checkbox5.isChecked()){

            bundle.putString("14", "5");
        ...
        if(finish && LoginManager.getInstance().isLogin()){
            ...
            DataManager.getInstance().sendDataSurvey(bundle, 5);

            Intent intent = new Intent(SurveyStress14.this, MainActivity.class);
